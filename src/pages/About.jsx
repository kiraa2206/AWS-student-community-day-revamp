...
export default function About() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-14">
      <div className="mb-16">
        <h1 className="font-display text-4xl font-bold mb-2 text-text-main">About the Group</h1>
      ...
      <div className="grid md:grid-cols-2 gap-16 mb-20">
        ...
        <div className="space-y-6 text-text-muted leading-relaxed">
          ...
          <div className="bg-panel-dark border border-border-subtle p-6 rounded-xl border-l-2 border-l-neon-purple mt-8 shadow-sm">
            <h2 className="font-display font-semibold text-lg text-text-main mb-2">Our Mission</h2>
            <p className="text-sm">
